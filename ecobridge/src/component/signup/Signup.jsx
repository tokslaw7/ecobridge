      ...
      <div className="row flex-grow-1">
        ...
        <div className="col-lg-6 d-flex flex-column justify-content-center bg-light p-5">
          <div className="mx-auto mx-lg-0" style={{ maxWidth: "500px" }}>
            ...
            <div className="bg-primary" style={{ height: "4px", width: "60px" }}></div>
            <p className="fst-italic text-muted mt-4 mb-4">
              "Join our inclusive creative community"
            </p>

            <div className="border border-2 border-dashed rounded p-3 mb-4 bg-white">
              <img
